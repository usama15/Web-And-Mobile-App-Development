...
const package_utils_1 = require("@webpack-cli/package-utils");
    ...
    return class extends yeoman_generator_1.default {
        ...
        default() {
            ...
            if (currentDirName !== this.props.name) {
                ...
                try {
                    mkdirp_1.default.sync(pathToProjectDir);
                }
                catch (err) {
                    logger_1.default.error('Failed to create directory', err);
                }
        ...
        install() {
            const packager = package_utils_1.getPackageManager();
